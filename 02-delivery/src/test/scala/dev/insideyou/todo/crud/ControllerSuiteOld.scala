...
final class ControllerSuiteOld extends TestSuite:
  import ControllerSuiteOld.{ *, given }
...
object ControllerSuiteOld:
  ...
  private class FakeFancyConsole[F[_]] extends FancyConsoleOld[F]:
  ...
  private class FakeRandom[F[_]] extends RandomOld[F]:
